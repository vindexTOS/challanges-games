...
const Start = () => {
  ...
  const style = {
    ...
    btn: `flex items-center justify-center text-[1.4rem] gap-4 text-gray-500 outline outline-[2px] outline-gray-300 rounded-[10px] px-5 py-2  max_sm:text-[1rem] hover:outline-blue-300`,
  }
  return (
