...
const Loto = () => {
  ...
  const style = {
    mainDiv: `w-[100vw] h-[100%] max_sm:w-[100%]  max_sm:h-[100%] py-10 max_lg:h-[100%]  bg-gray-100 flex items-center justify-center max_sm:flex-col `,
    ...
    ticketSection: `  w-[50%] max_sm:w-[100%] py-10 max_XL3:w-[50%] max_lg:h-[100%] max_lg:w-[90%]  border-2  h-[100%] flex flex-col gap-5`,
    drawSection: `w-[50%] max_sm:w-[100%] max_sm:h-[100%]  max_XL3:w-[50%] max_lg:h-[1000px]  max_lg:w-[90%] h-[90%] border-2 `,
  }
  return (
